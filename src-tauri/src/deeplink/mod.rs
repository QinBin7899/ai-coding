//! Deep link import functionality for AI Coding
//!
//! This module implements the aicoding:// protocol for importing configurations
...
///
/// Represents a parsed aicoding:// URL ready for processing.
