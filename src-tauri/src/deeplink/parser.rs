...
//!
//! Parses aicoding:// URLs into DeepLinkImportRequest structures.
...
/// Parse a aicoding:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// aicoding://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "aicoding" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'aicoding', got '{scheme}'"
        )));
    }
